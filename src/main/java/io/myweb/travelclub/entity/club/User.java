...
import io.myweb.travelclub.util.exception.InvalidEmailException;
...
public class User extends Entity {
    ...
    public static User sample() {
        //
        User user = new User("lee@mail.com", "lee", "010-3321-1001");
        user.setBirthDay("2001.09.23");
        user.getAddresses().add(Address.sampleHomeAddress());
        return user;
    }
